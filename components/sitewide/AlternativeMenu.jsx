    ...
    <>
      ...
      <AnimatePresence>
        {isVisible && (
          <>
            <a.button
              className="hover:cursor-pointer hidden lg:block fixed top-5 right-[7.25rem] z-[99] shadow"
              initial="initial"
              animate="visible"
              exit="initial"
              variants={buttonVariants}
            ...
            >
              <Link className="" href={"/contact"}>
                <div className="hover:opacity-75 transition-all duration-200 px-4 py-2 accent__c_main rounded-lg">
                  <p className="2xl:text-base text-sm button__text_colour">Contact Me</p>
                </div>  
              </Link>
            </a.button>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <a.div
            className="fixed top-0 flex flex-col justify-center right-0 bottom__left_radius xl:rounded-none h-full bg-gray-900 shadow-2xl z-[500]"
